            ...
            <div class="panel-body">
                ...
                <div id="faq0">
                    ...
                    <p>If you are signed in to your account, you can give your map a title so you can find it again in
                        your dashboard.</p>
                    <p class="alert brand-shadow alert-info"><i class="fa fa-info-circle"></i> You must be signed in to
                        save maps.</p>
                    <hr class="brand-shadow">
                </div>
                <div id="faq1">
                    ...
                    <p class="alert brand-shadow alert-warning"><i class="fa fa-exclamation-circle"></i> If your map
                ...
                <div id="faq2">
                    ...
                    <p>This is just the ID of the element you want your map to appear in. It's produced in the code
                        given so unless you have another element on your page with the same ID you don't probably need
                        to change this.</p>
                    <hr class="brand-shadow">
                </div>
                <div id="faq3">
                ...
                <div id="faq8">
                    ...
                    <ul class="list-unstyled">
                        <li><h4>Streetview Control</h4>
                            ...
                            <p class="alert brand-shadow alert-info"><i class="fa fa-info-circle"></i> If you are in
                                streetview mode when you save a map,
                                this won't be shown,
                                you
                ...
                <div id="faq9">
                    ...
                    <p class="alert brand-shadow alert-info"><i class="fa fa-info-circle"></i> You can only save a map
                        when signed in.</p>
                    ...
                    <p>Deleting a map simply removes all records of the map from your account. Any marker icons saved
                        during this maps's creation are not removed from your account so you can use them again in
                        future
                        maps.</p>
                    <hr class="brand-shadow">
                </div>
                <div id="faq10">
                    ...
                    <p>The brilliant people at <a target="_blank" href="https://snazzymaps.com/">Snazzy Maps</a> have
                        made their theme
                        repository available to us for you to use on your maps. We currently have 1000 themes in our
                        platform but if you see one on <a target="_blank" href="https://snazzymaps.com/">Snazzy Maps</a>
                        that we don't
