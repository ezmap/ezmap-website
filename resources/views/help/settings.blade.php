...
<div id="faq1">
    ...
    <p>Users of the Google Map API are supposed to use their own API key. This is a series of
        numbers and letters that identifies the map as belonging to you. If you have an API key you
        can
    ...
    <ui-alert type="warning" dismissible="false">If your map will feature in a commercial product
        you
...
<div id="faq3">
    ...
    <p>This is the width and height of your map in pixels. If you want your map to be as wide as
        whatever bit of the page you put it in, select the "Responsive Width" option. If you choose
        the
...
<div id="faq4">
    ...
    <p>These numbers are the {{ trans('ezmap.center') }} of your map. If you know the latitude and
        longitude you want to {{ trans('ezmap.center') }} your map at you can fill this in.
        Otherwise,
...
<div id="faq6">
    ...
    <p>This sets how zoomed in on the map you are when it loads. Any whole number between 0 (zoomed
        right out) and around 21, depending on the particular map position can be used here. This
        reacts
    ...
    <ol>
        ...
        <li>
            ...
            <ui-alert type="info" dismissible="false">
                ...
                <br>Top tip, try zooming right in to where you want your marker before placing it,
                then
            ...
            <ul>
                ...
                <li>
                    <p>{{ ucfirst(trans('ezmap.center')) }} Here - Clicking the
                        ...
                        button will {{ trans('ezmap.center') }} the map on that marker's position.
                        If
                        you resize the map or move it around you may need to click this button again
                        to
...
<div id="faq8">
    ...
    <ul class="list-unstyled">
        ...
        <li>
            ...
            <p>
                This is a small button on the top-right of the map that allows a person to make the
                map
        ...
        <li>
            ...
            <p>You can double-click your mouse on the map to zoom in (and hold <kbd>ctrl</kbd> and
                double-click to zoom out). Deselecting this option stops this functionality on your
                map.
            </p>
        </li>
        <li>
        ...
        <li>
            ...
            <p>You can control Google Maps navigation
                <a href="https://sites.google.com/a/umich.edu/going-google/accessibility/google-maps-keyboard-shortcuts" target="_blank">
                    by using the keyboard</a>. Deselecting this option disables that functionality
                on
                your map.</p>
        </li>
        <li>
...
<div id="faq10">
    ...
    <p>If you want to try a theme on your map just click the preview icon for it and your map will
        be
