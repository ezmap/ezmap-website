      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
        ...
        <div class="flex items-center gap-4">
          <flux:dropdown position="top" align="end">
            <flux:button variant="ghost" size="sm" icon="swatch" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300">Appearance</flux:button>
            <flux:menu>
              <flux:menu.item x-data x-on:click="$flux.appearance = 'light'" icon="sun">Light</flux:menu.item>
              <flux:menu.item x-data x-on:click="$flux.appearance = 'dark'" icon="moon">Dark</flux:menu.item>
              <flux:menu.item x-data x-on:click="$flux.appearance = 'system'" icon="computer-desktop">System</flux:menu.item>
            </flux:menu>
          </flux:dropdown>
