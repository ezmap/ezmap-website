...
class EzTranslatorService
{
  ...
  {
    return (trans("image.{$this->translation}") == "image.{$this->translation}") ?
        $this->default :
        trans('image.' . $this->translation);
  }

  public static function image($translation, $default = null)
  {
    $default = $default ?? $translation;

    return (new static($translation, $default))->imageTranslation();
  }
