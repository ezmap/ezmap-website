...
exports.default = {
    ...
    methods: {
        markersLoop: function markersLoop() {
            ...
            for (var i = 0; i < this.markers.length; i++) {
                ...
                if (marker.infoWindow) {
                    str += 'var infowindow' + i + ' = new google.maps.InfoWindow({content: ' + (0, _stringify2.default)(marker.infoWindow.content) + ',map: map});\n';
        ...
        clearCopied: function clearCopied() {
